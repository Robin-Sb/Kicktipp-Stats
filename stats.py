...
def plot_points_per_team_merged(input):
    resolution, amplitude = map_data(input)
    save_pie_plot(resolution, amplitude, "points_per_prediction", "all")


for team in team_results:
    plot_scores_per_team(team_results[team], team)

plot_all_scores_per_team(all_results_merged)
plot_close_calls(close_calls)
plot_missed_games(missed_games)
...
for player_index in points_per_team:
    ...
    save_pie_plot(resolution, amplitude, "points_per_prediction", players[index])
